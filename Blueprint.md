...
- Containerized parser: The parser is packaged from GitHub as a versioned artifact/container, and we embed parser_version in every output row or store that information along with the files.
