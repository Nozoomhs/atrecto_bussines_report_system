...
NegligenceAgent
---------------
Consumes a prompt produced by PromptParser for the "gross_negligence" task and
...
ALLOWED_LABELS = {"none", "ownership_issue"}
    ...
    def run(self, prompt: str) -> Dict[str, Any]:
        ...
        for _ in range(self.max_retries + 1):
            try:
                ...
                obj = OwnershipOutput.model_validate(payload)
...
if __name__ == "__main__":
    import argparse
    ap = argparse.ArgumentParser(description="Run NegligenceAgent on a prebuilt prompt JSON")
    ...
    agent = OwnershipAgent(backend=backend, max_retries=args.retries)
