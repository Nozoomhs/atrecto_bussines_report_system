...
CostAgent
---------
Consumes a prompt produced by PromptParser for the "cost_considerations" task and
...
ALLOWED_LABELS = {"no_cost", "cost_involved"}
    ...
    def run(self, prompt: str) -> Dict[str, Any]:
        ...
        for _ in range(self.max_retries + 1):
            try:
                ...
                obj = CostOutput.model_validate(payload)
...
if __name__ == "__main__":
    import argparse
    ap = argparse.ArgumentParser(description="Run CostAgent on a prebuilt prompt JSON")
    ...
    agent = CostAgent(backend=backend, max_retries=args.retries)
